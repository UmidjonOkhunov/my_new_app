...
class PolylineAnnotationExampleState extends State<PolylineAnnotationExample> {
  ...
  _onMapCreated(MapboxMap mapboxMap) {
    ...
    mapboxMap.setCamera(CameraOptions(center: Point(coordinates: Position(0, 0)), zoom: 1, pitch: 0));
    mapboxMap.annotations.createPolylineAnnotationManager().then((value) {
      ...
      polylineAnnotationManager?.createMulti(positions
          .map((e) => PolylineAnnotationOptions(geometry: LineString(coordinates: e), lineColor: createRandomColor()))
          .toList());
      polylineAnnotationManager?.addOnPolylineAnnotationClickListener(AnnotationClickListener());
    });
  }
    ...
    return TextButton(
      ...
      onPressed: () {
        if (polylineAnnotation != null) {
          ...
          var newlineString =
              LineString(coordinates: lineString.coordinates.map((e) => Position(e.lng + 1.0, e.lat + 1.0)).toList());
              ...
              FloatingActionButton(
                  ...
                  onPressed: () {
                    if (polylineAnnotationManager != null) {
                      mapboxMap?.annotations.removeAnnotationManager(polylineAnnotationManager!);
